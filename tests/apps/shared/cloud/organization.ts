...
export const organizationName = pageComponents.cloud.input('Organization Name', 'organization Name');
export const producerCode = pageComponents.cloud.dropdown('Producer Code', 'producer code');
